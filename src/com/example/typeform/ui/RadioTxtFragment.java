...
import com.example.typeform.ui.util.ListRadioTxtAdapter;
...
public class RadioTxtFragment extends Fragment{

	private View rootView;
	private ListRadioTxtAdapter adapter;

	public RadioTxtFragment() {
	}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		answerList.add(answer);
		answer = new AnswerModel("5","E","answer5","5","editText",false);
		answerList.add(answer);
		...
		adapter = new ListRadioTxtAdapter(getActivity().getApplicationContext(),R.layout.listrow_radio,answerList);
